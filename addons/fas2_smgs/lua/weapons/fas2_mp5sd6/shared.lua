...
SWEP.Attachments = {[1] = {header = "Sight", sight = true, x = 500, y = -100, atts = {"compm4"}},
	[2] = {header = "Forearm", x = -10, y = 0, atts = {"foregrip"}}}
...
SWEP.VM = "models/weapons/view/smgs/mp5sd6.mdl"
...
SWEP.Damage = 23
SWEP.FireSound_Suppressed = Sound("FAS2_MP5SD6")
