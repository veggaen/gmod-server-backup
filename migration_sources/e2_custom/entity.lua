...
e2function number entity:radius()
	if not I(this) then return 0 end
...
e2function number entity:isShipmentName()
	if not IsValid(this) then return 0 end
	if this:IsShipmentName() then return 1 else return 0 end
end
/**********************************************************************
e2function number entity:getPrinted()
	...
	if this:GetClass("normal_money_printer", "gold_money_printer", "ruby_money_printer", "nuclear_money_printer")then  
